 ...
 * @oddjob.example A simple list of things. The list contains 3 things two Strings and a
 ...
 * @oddjob.example A Merged list. This list merges a plain value, a sub list
 ...
 * @oddjob.example A Converted list. The elements of the list are converted to an array of
 * Strings.
 ...
 * elements.
 * @oddjob.example Add to a list the fly. This example demonstrates setting the
...
public class ListType implements ArooaValue, Serializable {
     ...
     * Set unique.
     *
     * @param unique true to make unique.
     */
