...
public class SessionArooaDocFactory
    ...
    public WriteableBeanDoc createBeanDoc(ArooaElement element,
        ...
        if (BeanType.ELEMENT.equals(element)) {
            ...
            propertyDoc.setPropertyName(BeanType.ATTRIBUTE);
            propertyDoc.setAccess(PropertyDoc.Access.READ_WRITE);
            propertyDoc.setMultiplicity(PropertyDoc.Multiplicity.SIMPLE);
			propertyDoc.setConfiguredHow(ConfiguredHow.ATTRIBUTE);
            beanDoc.addPropertyDoc(propertyDoc);
            ...
            for (WriteablePropertyDoc propertyDoc : propertyDocs) {
