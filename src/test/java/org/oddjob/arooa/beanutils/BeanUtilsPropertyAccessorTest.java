 ...
 */
public class BeanUtilsPropertyAccessorTest extends Assert {
    ...
    public void testAttributeSetters() throws ArooaException, NoConversionAvailableException, ConversionFailedException {
        ...
        // set Integer on int
        bubh.setProperty(subject, "six", 2);
    ...
    public void testAttributeGetters() throws ArooaException, ArooaPropertyException, ArooaConversionException {
        ...
        MatcherAssert.assertThat(eleven2, Matchers.nullValue());
    ...
    public void testNestedSet() {
        ...
        // set Integer on int
        test.setProperty(subject, "nested.six", 2);
...
//        }
    ...
    /**
     * Test getting the property type.
     */
    @Test
    ...
    public void testPropertyType2() throws Exception {
        // first look at an array without an indexed accessor.
