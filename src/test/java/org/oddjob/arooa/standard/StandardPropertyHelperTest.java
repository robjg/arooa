...
public class StandardPropertyHelperTest extends Assert {
    ...
    private static class NestedPropPropertyAccessor extends MockPropertyAccessor {
        @Override
    ...
    public void setUp() throws Exception {
        ...
        converter = new DefaultConverter(lookup);
    ...
    public void testObjectReplacement() throws ArooaConversionException {
        beanRegistry.register("an-int", 2);
        assertExpandsTo("${an-int}", 2);
    ...
    private static class OurConvertletProvider implements ConversionProvider {
